...
public class TestAggs {
    ...
    public void testFilterAggs() throws Exception {
        FiltersAggregator.KeyedFilter[] filters = {new FiltersAggregator.KeyedFilter("0101",
                QueryBuilders.matchPhraseQuery("risk_code", "0101")), new FiltersAggregator.KeyedFilter("0103",
                QueryBuilders.matchQuery("risk_code", "0103"))};
    ...
    public void testDateHistogramAggs() throws Exception {
        Map map = elasticsearchTemplate.dateHistogramAggs("sum_premium", AggsType.sum, null, Main2.class, "input_date",
